...
export default function PaginatedPreview({
  ...
  const { margin } = resolveAppearance(resume.appearance)
  ...
  return (
    <>
      <style>{`@media print { @page { size: A4 portrait; margin: ${margin}mm; } }`}</style>
      ...
      <p className="pagination-hint">
        {editing
          ...
          : `修改左侧内容，分页同步更新 · A4 / 100% / 页边距 ${margin}mm`}
      </p>
      <div
